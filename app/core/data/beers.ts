...
export const mockBeers: Beer[] = [
  {
    ...
    description:
      'A tropical explosion of citrus and stone fruit flavors with a pillowy soft mouthfeel.',
    tastingNotes:
      'Bursting with notes of mango, pineapple, and citrus zest. The oat-heavy grain bill provides a silky smooth body with minimal bitterness.',
    flavorProfile: {
      hoppy: 85,
      bitter: 35,
      sweet: 45,
  ...
  },
  {
    ...
    description:
      'A rich, decadent imperial stout with notes of dark chocolate, espresso, and vanilla.',
    tastingNotes:
      "Deep roasted malt character with layers of baker's chocolate, fresh espresso, and hints of dark cherry. Finishes with warming bourbon notes.",
    flavorProfile: {
      hoppy: 20,
      bitter: 60,
      sweet: 70,
  ...
  },
  {
    ...
    tastingNotes:
      'Bright, zippy acidity balanced by natural citrus sweetness. Vibrant orange and grapefruit notes dance on the palate with a clean, dry finish.',
    flavorProfile: {
      hoppy: 10,
      bitter: 15,
      sweet: 50,
  ...
  },
  {
    ...
    description:
      'A crisp, clean German-style lager with delicate malt sweetness and noble hop character.',
    tastingNotes:
      'Light bready malt with subtle honey notes. Crisp and refreshing with a gentle floral hop finish. The epitome of drinkability.',
    flavorProfile: {
      hoppy: 30,
      bitter: 25,
      sweet: 40,
  ...
  },
  {
    ...
    tastingNotes:
      'Resinous pine needle and dank cannabis notes upfront, followed by bright grapefruit and orange peel. Clean, bitter finish that begs another sip.',
    flavorProfile: {
      hoppy: 95,
      bitter: 80,
      sweet: 20,
  ...
  },
  {
    ...
    description:
      'A traditional Belgian abbey ale with rich malt complexity and spicy yeast character.',
    tastingNotes:
      'Deep amber with notes of dark fruit, caramel, and brown sugar. Distinctive Belgian yeast contributes clove and black pepper spiciness.',
    flavorProfile: {
      hoppy: 15,
      bitter: 30,
      sweet: 65,
  ...
  },
  {
    ...
    tastingNotes:
      'Vibrant raspberry jumps from the glass. Tart, funky, and complex with a dry, champagne-like finish. Oak and brett add depth.',
    flavorProfile: {
      hoppy: 5,
      bitter: 10,
      sweet: 35,
  ...
  },
  {
    ...
    description:
      'A robust porter brewed with alder-smoked malts for a distinctive campfire character.',
    tastingNotes:
      'Rich, smoky aroma leads to flavors of dark chocolate, coffee, and campfire. Medium body with a smooth, slightly sweet finish.',
    flavorProfile: {
      hoppy: 25,
      bitter: 45,
      sweet: 50,
