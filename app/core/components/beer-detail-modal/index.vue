...
const foodIcons: Record<string, Component> = {
  burger: Sandwich,
  steak: Beef,
  tacos: Sandwich,
  cheese: CircleDot,
              ...
              <div class="space-y-3">
                ...
                >
                  <div class="flex items-start justify-between mb-2">
                    <div class="flex items-center gap-2">
                      <div
                        class="w-8 h-8 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center text-midnight-950 font-bold text-sm"
                      >
