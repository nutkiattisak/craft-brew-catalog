  ...
  <section class="py-12 lg:py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex items-center justify-between mb-8">
        <div>
          <h2 class="text-2xl lg:text-3xl font-bold text-foam-50">The Catalog</h2>
          <p class="text-foam-400 mt-1">{{ filteredBeers.length }} beers available</p>
        </div>
      </div>
      ...
      <div class="flex justify-center mt-12">
        <UiButton variant="outline" size="lg"> Load More Beers </UiButton>
      </div>
    </div>
  </section>
</template>
